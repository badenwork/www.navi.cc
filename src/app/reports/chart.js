...
angular.module('reports.chart', ['ngRoute', '$strap', 'resources.geogps', 'app.filters', 'config.system.params.master', 'config.system.params.fuel', 'services.tags', 'i18n', 'directives.datepicker'])
